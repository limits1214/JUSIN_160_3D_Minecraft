...
CResQuadFullscreenTexBuffer::CResQuadFullscreenTexBuffer(const _string& sPath, ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
    : CResQuadBuffer(sPath, pDevice, pContext)
{
}

CResQuadFullscreenTexBuffer::~CResQuadFullscreenTexBuffer()
{
}

HRESULT CResQuadFullscreenTexBuffer::Load(const std::any& arg)
{
...

    {
        ...
        {
            {_float3{-1.f, 1.f, 0.f},  _float2{0.f, 0.f}},
            {_float3{1.f, 1.f, 0.f},   _float2{1.f, 0.f}},
            {_float3{1.f, -1.f, 0.f},  _float2{1.f, 1.f}},
            {_float3{-1.f, -1.f, 0.f}, _float2{0.f, 1.f}}
        };
...
HRESULT CResQuadFullscreenTexBuffer::Unload(const std::any& arg)
{
    m_iNumIndices = {};
    m_iNumVertices = {};
    m_iVertexStride = {};
