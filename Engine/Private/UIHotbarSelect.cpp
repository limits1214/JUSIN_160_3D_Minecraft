...
CUIHotBarSelect::CUIHotBarSelect()
{
}
...
void CUIHotBarSelect::UpdateGUI()
{
	CUIObject::UpdateGUI();
...
void CUIHotBarSelect::PriorityUpdate(E::_float fTimeDelta)
{
}
...
HRESULT CUIHotBarSelect::Render(ID3D11DeviceContext* pContext, const E::RENDER_CTX& ctx)
{
...
E::UPtr<CUIHotBarSelect> CUIHotBarSelect::Create()
{
	auto pInstance = E::ToUPtr(new CUIHotBarSelect{});
	if (FAILED(pInstance->InitializePrototype()))
	{
		MSG_BOX("Failed to Created : CUIHotBarSelect");
		return nullptr;
	}
	return  pInstance;
}

E::UPtr<E::CPrototype> CUIHotBarSelect::Clone(void* pArg)
{
	auto	pInstance = E::ToUPtr(new CUIHotBarSelect{ *this });
	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CUIHotBarSelect");
		return nullptr;
	}
