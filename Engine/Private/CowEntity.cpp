...
HRESULT CCowEntity::Initialize(void* pArg)
{
    m_Bones = {
        ...
        EntityBone{
            ...
            .pivot = { 0, 20, -9 },
            .cubes = {
                EntityCube{.origin = { -4, 16, -15 }, .size = { 8, 8, 6 }, .uv { 0,0 }, .texIndex = 2 },
                EntityCube{.origin = { -3, 16, -16 }, .size = { 6, 3, 1 }, .uv { 1, 33 }, .texIndex = 2 },
                EntityCube{.origin = { -5, 22, -14 }, .size = { 1, 3, 1 }, .uv { 22, 0 }, .texIndex = 2 },
                EntityCube{.origin = { 4, 22, -14 }, .size = { 1, 3, 1 }, .uv { 22, 0 }, .texIndex = 2 },
            },
            .locators = {
                {"lead", { 0, 20, -9 }}
            }
        ...
        EntityBone{
            ...
            .pivot = { 0, 19, 1 },
            .cubes = {
                 EntityCube{.origin = { -6, 29, 14 }, .size = { 12, 18, 10 }, .rotation = {90, 0, 0},.uv {18, 4}, .texIndex = 2, .pivot = { 0, 18, 20}  },
                  EntityCube{.origin = { -2, 29, 13 }, .size = { 4, 6, 1 }, .rotation = {90, 0, 0},.uv {52, 0 }, .texIndex = 2 , .pivot = {0, 18, 20} },
            },
            .locators = {
                {"lead_hold", {0, 34, 0 }}
            }
        ...
        EntityBone{
            ...
            .pivot = { -4, 12, 6  },
            .cubes = {
                 EntityCube{.origin = { -6, 0, 4 }, .size = { 4, 12, 4 }, .uv {0, 16}, .texIndex = 2  },
            }
        },
        ...
        EntityBone{
            ...
            .pivot = { 4, 12, 6 },
            .cubes = {
                 EntityCube{.origin = { 2, 0, 4 }, .size = { 4, 12, 4 }, .uv {0, 16}, .texIndex = 2  },
            },
            .mirror = true,
        },
        ...
        EntityBone{
           ...
           .pivot = {-4, 12, -7},
           .cubes = {
                EntityCube{.origin = { -6, 0, -8}, .size = {4, 12, 4}, .uv {0, 16}, .texIndex = 2  },
           }
        },
         EntityBone{
            .name = "leg3",
            ...
            .pivot = {4, 12, -7},
            .cubes = {
                 EntityCube{.origin = { 2, 0, -8 }, .size = {4, 12, 4}, .uv {0, 16}, .texIndex = 2  },
            },
            .mirror = true,
        },
    };
