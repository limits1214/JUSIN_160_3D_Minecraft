...
HRESULT CResQuadItemVIBuffer::Load(const std::any& arg)
{
    ...
    m_eState = STATE::LOADING;
    {
        ...
        {
            {_float3{-0.5f, 0.5f, 0.f},_float3{0.f, 0.f, -1.f},  _float2{0.f, 0.f},PackTexId(8, argDesc->resourceIdx)},
            {_float3{0.5f, 0.5f, 0.f},_float3{0.f, 0.f, -1.f},  _float2{1.f, 0.f},PackTexId(8, argDesc->resourceIdx)},
            {_float3{0.5f, -0.5f, 0.f},_float3{0.f, 0.f, -1.f},  _float2{1.f, 1.f},PackTexId(8, argDesc->resourceIdx)},
            {_float3{-0.5f, -0.5f, 0.f},_float3{0.f, 0.f, -1.f},  _float2{0.f, 1.f},PackTexId(8, argDesc->resourceIdx)}
        };
